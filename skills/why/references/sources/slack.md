...
Slack MCP tools vary. Check which Slack MCP is available and inspect its tool schema first. It may require authentication. If authentication fails, stop and report the gap.
