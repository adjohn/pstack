...
4. Pick the worker model from `swarm workers` in `~/.claude/pstack-models.md` when present. Otherwise use `haiku`. For a model race, name each arm's model up front.
